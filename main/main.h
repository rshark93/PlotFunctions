...
class calculate_function {
	...
	inline static calculate_function* instance_{ nullptr };
	calculate_function();
	~calculate_function();
public:
	...
	// Singleton implementation
	inline static calculate_function* get_instance();
	inline static void reset_instance();
	calculate_function(const calculate_function&) = delete;
	calculate_function& operator=(const calculate_function&) = delete;
	calculate_function(const calculate_function&&) = delete;
	calculate_function& operator=(const calculate_function&&) = delete;
};